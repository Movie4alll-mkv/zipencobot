...
try:
    ...
    BOT_TOKEN = config("BOT_TOKEN","5301171607:AAHhzknu7lw5Ipf-HSCLRL7c7w4r3jiE0MI")
    DEV = 1664850827
    ...
    THUMBNAIL = config("THUMBNAIL", default="https://telegra.ph/file/de709fggfefff463ace84b278.jpg")
